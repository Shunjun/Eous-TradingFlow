...
import { Check, Ellipsis, Eye, GitBranch, ListTree, Rocket, Save, ScrollText } from 'lucide-react'
import {
  Button,
  DropdownMenu,
  DropdownMenuContent,
  ...
  return (
    ...
    >
      ...
      <div className="flex min-w-0 flex-1 items-center gap-3">
        ...
        <span className="min-w-0 flex-1 truncate text-xs text-muted-foreground" title={statusText}>
          {statusText}
        </span>
      </div>
